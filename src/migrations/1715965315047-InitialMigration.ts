...
export class InitialMigration1715965315047 implements MigrationInterface {
    name = 'InitialMigration1715965315047'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "products" ("id" SERIAL NOT NULL, "name" character varying(100) NOT NULL, "quantity" double precision NOT NULL, "price" double precision NOT NULL, "supplier" character varying(200), "unitOfMeasurement" "public"."products_unitofmeasurement_enum" NOT NULL DEFAULT 'Unidade', "companyId" integer, CONSTRAINT "PK_0806c755e0aca124e67c0cf6d7d" PRIMARY KEY ("id"))`);
