...
export class InitialMigration1732645572044 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "pedido_products_products" ("pedidoId" integer NOT NULL, "productsId" integer NOT NULL, CONSTRAINT "PK_1a5726732958772731550640cbe" PRIMARY KEY ("pedidoId", "productsId"))`);
        await queryRunner.query(`CREATE INDEX "IDX_755a6b5068759a04a2f5c2b87c" ON "pedido_products_products" ("pedidoId") `);
        await queryRunner.query(`CREATE INDEX "IDX_8ce9adc7ba269346e53254a4a6" ON "pedido_products_products" ("productsId") `);
        ...
        await queryRunner.query(`ALTER TABLE "pedido_products_products" ADD CONSTRAINT "FK_755a6b5068759a04a2f5c2b87c7" FOREIGN KEY ("pedidoId") REFERENCES "pedido"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "pedido_products_products" ADD CONSTRAINT "FK_8ce9adc7ba269346e53254a4a60" FOREIGN KEY ("productsId") REFERENCES "products"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "pedido_products_products" DROP CONSTRAINT "FK_8ce9adc7ba269346e53254a4a60"`);
        await queryRunner.query(`ALTER TABLE "pedido_products_products" DROP CONSTRAINT "FK_755a6b5068759a04a2f5c2b87c7"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_8ce9adc7ba269346e53254a4a6"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_755a6b5068759a04a2f5c2b87c"`);
        await queryRunner.query(`DROP TABLE "pedido_products_products"`);
