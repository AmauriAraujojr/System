...
export class InitialMigration1733425976038 implements MigrationInterface {
    name = 'InitialMigration1733425976038'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "pizza" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "price_G" character varying NOT NULL, "price_M" character varying NOT NULL, "price_P" character varying NOT NULL, "description" text, "img" text, "borda" jsonb NOT NULL, "companyId" integer, CONSTRAINT "PK_cb1970bd1d17619fd6bc1ec7414" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."pizza_option_size_enum" AS ENUM('Pequena', 'Média', 'Grande')`);
        await queryRunner.query(`CREATE TABLE "pizza_option" ("id" SERIAL NOT NULL, "size" "public"."pizza_option_size_enum" NOT NULL, "price" character varying NOT NULL, "obs" text, "halfAndHalf" boolean NOT NULL DEFAULT false, "borda" json NOT NULL, "halfOptionsId" integer, "pizzaId" integer, CONSTRAINT "PK_9c9c638c805a27325874d32c048" PRIMARY KEY ("id"))`);
